        ...
        {isOpen ? (  
          <div className="modal">
            <section>
              ...
              <main onClick={isOpen}>
                <text style={{fontSize:"37px", margin:"2vh"}}>신촌대 맛집전공 원서 제출</text>
                <text style={{fontSize:"24px",margin:"2vh"}}>응시 방법을 선택하세요.</text>
                <BtnWrapper>
                  <a href='https://matzipmajor.com/oauth2/authorization/kakao'>
                    <img src={loginKakao} style={{margin:'1vh'}}/>
                  </a>
                  <a href='https://matzipmajor.com/oauth2/authorization/naver'>
                    <img src={loginNaver} style={{margin:'1vh'}}/>
                  </a>
                  <a href='https://matzipmajor.com/oauth2/authorization/google'>
                  <img src={loginGoogle} style={{margin:'1vh'}}/>
                  </a>
                </BtnWrapper>
              </main>
              <footer>
                <img src={logo} width="80px" height='40vh'></img>
              </footer>
            </section>
          </div>
        ) : null}
